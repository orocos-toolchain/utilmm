...
ELSE (_boost_IN_CACHE)
  ...
  IF(Boost_INCLUDE_DIR)
    ...
    FOREACH(COMPONENT ${Boost_FIND_COMPONENTS})
      ...
      IF(NOT Boost_${UPPER_COMPONENT}_FOUND)
        MESSAGE(STATUS "cannot find boost/${COMPONENT}")
        SET( Boost_FOUND FALSE)
      ENDIF(NOT Boost_${UPPER_COMPONENT}_FOUND)
    ENDFOREACH(COMPONENT)
  ELSE(Boost_INCLUDE_DIR)
    SET( Boost_FOUND FALSE)
  ENDIF(Boost_INCLUDE_DIR)
  ...
  ELSE (Boost_FOUND)
      IF (Boost_FIND_REQUIRED)
        MESSAGE(FATAL_ERROR "Boost and/or some required components not found. Please install the Boost libraries AND development packages")
